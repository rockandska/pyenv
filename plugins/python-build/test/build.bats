...
load test_helper
_setup() {
  export PYTHON_BUILD_CACHE_PATH="$HOME/cache"
  export MAKE=make
...
yaml-0.1.6: CFLAGS="" CPPFLAGS="-I${HOME}/install/include" LDFLAGS="-L${HOME}/install/lib -Wl,-rpath,${HOME}/install/lib" PKG_CONFIG_PATH=""
yaml-0.1.6: --prefix=$INSTALL_ROOT
make -j 2
make install
Python-3.6.2: CFLAGS="" CPPFLAGS="-I${HOME}/install/include" LDFLAGS="-L${HOME}/install/lib -Wl,-rpath,${HOME}/install/lib" PKG_CONFIG_PATH=""
...
@test "apply global and package-specific flags, package flags come later to have precedence" {
  ...
  assert_build_log <<OUT
yaml-0.1.6: CFLAGS="yaml_cflag1 yaml_cflag2" CPPFLAGS="-I${HOME}/install/include yaml_cppflag1 yaml_cppflag2" LDFLAGS="-L${HOME}/install/lib -Wl,-rpath,${HOME}/install/lib yaml_ldflag1 yaml_ldflag2" PKG_CONFIG_PATH=""
...
@test "apply python patch before building" {
  ...
  TMPDIR="$HOME" install_fixture --patch definitions/needs-yaml <<<""
  assert_success
...
make -j 2
make install
patch -p0 --force -i $HOME/python-patch.XXX
Python-3.6.2: CFLAGS="" CPPFLAGS="-I${HOME}/install/include" LDFLAGS="-L${HOME}/install/lib -Wl,-rpath,${HOME}/install/lib" PKG_CONFIG_PATH=""
Python-3.6.2: --prefix=$INSTALL_ROOT --enable-shared --libdir=$INSTALL_ROOT/lib
make -j 2
make install
...
@test "apply python patch from git diff before building" {
  ...
  TMPDIR="$HOME" install_fixture --patch definitions/needs-yaml <<<"diff --git a/script.py"
  assert_success
...
make -j 2
make install
patch -p1 --force -i $HOME/python-patch.XXX
Python-3.6.2: CFLAGS="" CPPFLAGS="-I${HOME}/install/include" LDFLAGS="-L${HOME}/install/lib -Wl,-rpath,${HOME}/install/lib" PKG_CONFIG_PATH=""
Python-3.6.2: --prefix=$INSTALL_ROOT --enable-shared --libdir=$INSTALL_ROOT/lib
make -j 2
make install
...
@test "Homebrew and port are tried if both are present in PATH in MacOS" {
  ...
  BREW_PREFIX="$HOME/homebrew-prefix"
...
DEF
  ...
  assert_build_log <<OUT
Python-3.6.2: CFLAGS="" CPPFLAGS="-I${HOME}/install/include -I$BREW_PREFIX/include" LDFLAGS="-L${HOME}/install/lib -Wl,-rpath,${HOME}/install/lib -L$BREW_PREFIX/lib -Wl,-rpath,$BREW_PREFIX/lib" PKG_CONFIG_PATH=""
Python-3.6.2: --prefix=$INSTALL_ROOT --enable-shared --libdir=$INSTALL_ROOT/lib
make -j 2
make install
OUT
...
DEF
  ...
  assert_build_log <<OUT
Python-3.6.2: CFLAGS="" CPPFLAGS="-I$PORT_PREFIX/include -I${HOME}/install/include" LDFLAGS="-L$PORT_PREFIX/lib -Wl,-rpath,$PORT_PREFIX/lib -L${HOME}/install/lib -Wl,-rpath,${HOME}/install/lib" PKG_CONFIG_PATH="${HOME}/lib/pkgconfig"
Python-3.6.2: --prefix=$INSTALL_ROOT --enable-shared --libdir=$INSTALL_ROOT/lib
make -j 2
make install
OUT
...
@test "yaml is linked from Homebrew" {
  ...
  brew_libdir="$HOME/homebrew-yaml"
  mkdir -p "$brew_libdir"
  ...
  assert_build_log <<OUT
Python-3.6.2: CFLAGS="" CPPFLAGS="-I$brew_libdir/include -I${HOME}/install/include" LDFLAGS="-L$brew_libdir/lib -L${HOME}/install/lib -Wl,-rpath,${HOME}/install/lib" PKG_CONFIG_PATH=""
Python-3.6.2: --prefix=$INSTALL_ROOT --enable-shared --libdir=$INSTALL_ROOT/lib
make -j 2
make install
OUT
...
@test "readline is linked from Homebrew" {
  ...
  readline_libdir="$HOME/homebrew-readline"
...
DEF
  ...
  assert_build_log <<OUT
Python-3.6.2: CFLAGS="" CPPFLAGS="-I$readline_libdir/include -I${HOME}/install/include" LDFLAGS="-L$readline_libdir/lib -L${HOME}/install/lib -Wl,-rpath,${HOME}/install/lib" PKG_CONFIG_PATH=""
Python-3.6.2: --prefix=$INSTALL_ROOT --enable-shared --libdir=$INSTALL_ROOT/lib
make -j 2
make install
OUT
...
@test "ncurses is linked from Homebrew" {
  ...
  ncurses_libdir="$HOME/homebrew-ncurses"
...
DEF
  ...
  assert_build_log <<OUT
Python-3.6.2: CFLAGS="" CPPFLAGS="-I$ncurses_libdir/include -I${HOME}/install/include" LDFLAGS="-L$ncurses_libdir/lib -L${HOME}/install/lib -Wl,-rpath,${HOME}/install/lib" PKG_CONFIG_PATH=""
Python-3.6.2: --prefix=$INSTALL_ROOT --enable-shared --libdir=$INSTALL_ROOT/lib
make -j 2
make install
OUT
...
@test "yaml is linked from MacPorts" {
  ...
  assert_build_log <<OUT
Python-3.6.2: CFLAGS="" CPPFLAGS="-I${HOME}/include -I${HOME}/install/include" LDFLAGS="-L${HOME}/lib -Wl,-rpath,${HOME}/lib -L${HOME}/install/lib -Wl,-rpath,${HOME}/install/lib" PKG_CONFIG_PATH="${HOME}/lib/pkgconfig"
Python-3.6.2: --prefix=$INSTALL_ROOT --enable-shared --libdir=$INSTALL_ROOT/lib
make -j 2
make install
OUT
...
DEF
    ...
    assert_build_log <<OUT
Python-3.6.2: CFLAGS="" CPPFLAGS="-I${HOME}/install/include -I/usr/local/include" LDFLAGS="-L${HOME}/install/lib -Wl,-rpath,${HOME}/install/lib -L/usr/local/lib -Wl,-rpath,/usr/local/lib" PKG_CONFIG_PATH=""
Python-3.6.2: --prefix=$INSTALL_ROOT --enable-shared --libdir=$INSTALL_ROOT/lib
make -j 1
make install
OUT
...
@test "tcl-tk is linked from Homebrew" {
  cached_tarball "Python-3.6.2"
  tcl_tk_version=8.6
  tcl_tk_libdir="$HOME/homebrew-tcl-tk"
...
DEF
  ...
  assert_build_log <<OUT
Python-3.6.2: CFLAGS="" CPPFLAGS="-I${HOME}/install/include" LDFLAGS="-L${HOME}/install/lib -Wl,-rpath,${HOME}/install/lib" PKG_CONFIG_PATH="${HOME}/homebrew-tcl-tk/lib/pkgconfig"
Python-3.6.2: --prefix=${HOME}/install --enable-shared --libdir=${HOME}/install/lib --with-tcltk-libs=-L${HOME}/homebrew-tcl-tk/lib -ltcl$tcl_tk_version -ltk$tcl_tk_version --with-tcltk-includes=-I${HOME}/homebrew-tcl-tk/include
make -j 2
make install
OUT
}
...
@test "tcl-tk is not linked from Homebrew when explicitly defined" {
  ...
  export PYTHON_CONFIGURE_OPTS="--with-tcltk-libs='-L${HOME}/custom-tcl-tk/lib -ltcl$tcl_tk_version -ltk$tcl_tk_version'"
  run_inline_definition <<DEF
install_package "Python-3.6.2" "http://python.org/ftp/python/3.6.2/Python-3.6.2.tar.gz"
DEF
  assert_success
  ...
  assert_build_log <<OUT
Python-3.6.2: CFLAGS="" CPPFLAGS="-I${HOME}/install/include" LDFLAGS="-L${HOME}/install/lib -Wl,-rpath,${HOME}/install/lib" PKG_CONFIG_PATH=""
Python-3.6.2: --prefix=$INSTALL_ROOT --enable-shared --libdir=$INSTALL_ROOT/lib --with-tcltk-libs=-L${HOME}/custom-tcl-tk/lib -ltcl8.6 -ltk8.6
make -j 2
make install
OUT
}
...
DEF
  ...
  assert_build_log <<OUT
Python-3.6.2: CFLAGS="" CPPFLAGS="-I${HOME}/install/include" LDFLAGS="-L${HOME}/install/lib -Wl,-rpath,${HOME}/install/lib" PKG_CONFIG_PATH="${HOME}/homebrew-tcl-tk/lib/pkgconfig"
Python-3.6.2: --prefix=${HOME}/install --enable-shared --libdir=${HOME}/install/lib
make -j 2
make install
OUT
}
...
DEF
  ...
  assert_build_log <<OUT
Python-3.6.2: CFLAGS="" CPPFLAGS="-I${HOME}/install/include" LDFLAGS="-L${HOME}/install/lib" PKG_CONFIG_PATH=""
...
DEF
  ...
  assert_build_log <<OUT
Python-3.6.2: CFLAGS="" CPPFLAGS="-I${HOME}/install/include" LDFLAGS="-L${HOME}/install/lib -Wl,-rpath,${HOME}/install/lib" PKG_CONFIG_PATH=""
Python-3.6.2: --prefix=$INSTALL_ROOT --enable-shared --libdir=${HOME}/install/lib --with-dsymutil
make -j 2
make install
OUT
}
...
DEF
  ...
  assert_build_log <<OUT
Python-3.6.2: CFLAGS="" CPPFLAGS="-I${HOME}/install/include" LDFLAGS="-L${HOME}/install/lib -Wl,-rpath,${HOME}/install/lib" PKG_CONFIG_PATH=""
Python-3.6.2: --prefix=$INSTALL_ROOT --enable-shared --libdir=${HOME}/install/lib
make -j 2
make install
OUT
}
...
@test "can use PYTHON_CONFIGURE to apply a patch" {
  ...
  executable "${HOME}/custom-configure" <<CONF
#!$BASH
...
CONF
  ...
  export PYTHON_CONFIGURE="${HOME}/custom-configure"
  run_inline_definition <<DEF
install_package "Python-3.6.2" "http://python.org/ftp/python/3.6.2/Python-3.6.2.tar.gz"
DEF
  assert_success
...
@test "non-writable HOMEDIR aborts build" {
  export TMPDIR="${HOME}/build"
  mkdir -p "$TMPDIR"
  chmod -w "$TMPDIR"

  touch "${HOME}/build-definition"
  run python-build "${HOME}/build-definition" "$INSTALL_ROOT"
